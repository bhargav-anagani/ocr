...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(authProvider, (_, state) {
      if (state.status == AuthStatus.authenticated) context.go('/dashboard');
    });
          ...
          child: SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.document_scanner_rounded, color: AppTheme.primary, size: 56)
                      .animate()
                  ...
                  Text('Start extracting text instantly',
